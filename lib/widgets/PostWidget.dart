...
import 'package:agora_ogaboss/pages/CommentsPage.dart';
...
class _PostState extends State<Post> {
  ...
  controlPostDelete(BuildContext nContext){
    return showDialog(
      context: nContext,
      builder:  (context)
        {
        ...
        Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Icon(
                Icons.chat_bubble_outline,size: 20.0,
                color: Colors.white,
              ),
            )
          ],
        ...
        Row(
          children: <Widget>[
            Container(
              ...
              child: Text("$likeCount  likes",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
            )
          ],
        ),
